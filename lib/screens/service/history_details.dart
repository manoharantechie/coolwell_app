...
class Service_History_Details extends StatefulWidget {
  ...
  @override
  State<Service_History_Details> createState() => _Service_History_DetailsState();
}
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Flexible(child: Text(
                                AppLocalizations.instance.text("loc_serv_details"),
                                style: CustomWidget(context: context)
                                    .CustomSizedTextStyle(
                                    18.0,
                                    Theme.of(context).primaryColor,
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(child: Text(
                                AppLocalizations.instance.text("loc_clean_foam"),
                                style: CustomWidget(context: context)
                                    .CustomSizedTextStyle(
                                    14.0,
                                    Theme.of(context).primaryColor,
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(child: Text(
                                AppLocalizations.instance.text("loc_clean_power"),
                                style: CustomWidget(context: context)
                                    .CustomSizedTextStyle(
                                    14.0,
                                    Theme.of(context).primaryColor,
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(child: Text(
                                AppLocalizations.instance.text("loc_indoor_outer"),
                                style: CustomWidget(context: context)
                                    .CustomSizedTextStyle(
                                    14.0,
                                    Theme.of(context).primaryColor,
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(child: Text(
                                AppLocalizations.instance.text("loc_duration"),
                                style: CustomWidget(context: context)
                                    .CustomSizedTextStyle(
                                    14.0,
                                    Theme.of(context).primaryColor,
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: photos ? BoxDecoration(
                                      borderRadius: BorderRadius.circular(30.0),
                                      gradient: LinearGradient(
                                        begin: Alignment.bottomLeft,
                                        end: Alignment.topRight,
                                    ...
                                    child:Row(
                                      ...
                                      children: [
                                        Icon(
                                          Icons.photo, color: Theme.of(context).focusColor, size: 15.0,
                                        ),
                                        const SizedBox(width: 5.0,),
                                        Text(
                                          AppLocalizations.instance.text("loc_photo"),
                                          style: CustomWidget(context: context)
                                              .CustomSizedTextStyle(
                                              10.0,
                                              Theme.of(context).focusColor,
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    padding: EdgeInsets.fromLTRB(10.0, 5.0, 10.0, 5.0),
                                    decoration: video ? BoxDecoration(
                                      borderRadius: BorderRadius.circular(30.0),
                                      gradient: LinearGradient(
                                        begin: Alignment.bottomLeft,
                                        end: Alignment.topRight,
                                    ...
                                    child:Row(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(width: 5.0,),
                                        Text(
                                          AppLocalizations.instance.text("loc_video"),
                                          style: CustomWidget(context: context)
                                              .CustomSizedTextStyle(
                                              10.0,
                                              Theme.of(context).focusColor,
